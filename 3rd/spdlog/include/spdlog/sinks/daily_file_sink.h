...
/*
 * Generator of daily EvisionLog file names in format basename.YYYY-MM-DD.ext
 */
...
/*
 * Generator of daily EvisionLog file names with strftime format.
 * Usages:
 *    auto sink =  std::make_shared<spdlog::sinks::daily_file_format_sink_mt>("myapp-%Y-%m-%d:%H:%M:%S.EvisionLog", hour, minute);"
 *    auto logger = spdlog::daily_logger_format_mt("loggername, "myapp-%Y-%m-%d:%X.EvisionLog", hour,  minute)"
 *
 */

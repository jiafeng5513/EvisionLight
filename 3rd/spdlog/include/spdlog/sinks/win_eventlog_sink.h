...
// 1. <log_name>    should be replaced with your EvisionLog name (e.g. your application name)
...
public:
        ...
        , event_id_(event_id)
    {
        ...
        catch (...)
        {
            ...
            // current_user_sid but in the event EvisionLog the record will have no user name
        }
    }
